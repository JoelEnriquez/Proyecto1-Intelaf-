...
public class AgregarCliente extends javax.swing.JDialog {
    ...
    public AgregarCliente(Usuarios usuarios, boolean modal,Connection conexion,InsertarData insertarD ) {
    ...
    private void initComponents() {
        ...
        efectivotxt = new javax.swing.JLabel();
        creditoJS = new javax.swing.JSpinner();
        efectivoJS = new javax.swing.JSpinner();
        ...
        creditotxt.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        creditotxt.setForeground(new java.awt.Color(0, 0, 0));
        creditotxt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        creditotxt.setText("Credito");
        getContentPane().add(creditotxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 570, 120, 50));
        ...
        getContentPane().add(apellidotxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 120, 50));
        ...
        NITtxt.setText("NIT");
        getContentPane().add(NITtxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 30, 120, 50));
        ...
        getContentPane().add(nombretxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 120, 50));
        ...
        getContentPane().add(correoElectronicoTF, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 450, 190, 50));

        NIT_TF.setFont(new java.awt.Font("Dialog", 0, 24)); // NOI18N
        getContentPane().add(NIT_TF, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 190, 50));

        efectivotxt.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        efectivotxt.setForeground(new java.awt.Color(0, 0, 0));
        efectivotxt.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        efectivotxt.setText("Efectivo");
        getContentPane().add(efectivotxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 510, 120, 50));

        creditoJS.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        creditoJS.setModel(new javax.swing.SpinnerNumberModel(55.5d, 1.0d, null, 5.0d));
        getContentPane().add(creditoJS, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 570, 140, 40));

        efectivoJS.setFont(new java.awt.Font("Dialog", 1, 24)); // NOI18N
        efectivoJS.setModel(new javax.swing.SpinnerNumberModel(185.5d, 1.0d, null, 50.0d));
        getContentPane().add(efectivoJS, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 520, 140, 40));
    ...
    private void checkButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkButtonActionPerformed
        if (faltaInfo()) {
            ...
            double credito = (Double)creditoJS.getValue();
            double efectivo = (Double)efectivoJS.getValue();
            
            Cliente cliente = new Cliente(nombre, apellido, NIT, correoElectronico, direccion, DPI, telefono, credito, efectivo);
            
            try {
                insertarD.crearCliente(conexion, cliente);
                JOptionPane.showMessageDialog(this, "Se ha creado el cliente","Felicidades", JOptionPane.INFORMATION_MESSAGE);
                this.setVisible(false);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, "No se ha podido crear el cliente","Error", JOptionPane.WARNING_MESSAGE);
            }
        }
    }//GEN-LAST:event_checkButtonActionPerformed

    private boolean faltaInfo(){
        return nombreTF.getText().trim().isEmpty()||apellidoTF.getText().trim().isEmpty()|| 
                telefonoTF.getText().trim().isEmpty()||NIT_TF.getText().trim().isEmpty();
    }
    ...
    private javax.swing.JSpinner creditoJS;
    private javax.swing.JLabel creditotxt;
    private javax.swing.JTextField direccionTF;
    private javax.swing.JLabel direcciontxt;
    private javax.swing.JSpinner efectivoJS;
    private javax.swing.JLabel efectivotxt;
